...
let CustomerService = class CustomerService {
    ...
    getMetadata() {
        return (0, metadata_decorators_1.getMetadata)(new model_1.Customer());
    }
    getCustomer(requestPayload, info) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const payload = Object.assign({ token: this.authService.getToken()[0] }, requestPayload.data);
            let result = yield (0, request_1.default)(endpoint, http_method_enum_1.HttpMethod.POST, this.authService.getToken(), payload);
            return result;
        });
    }
